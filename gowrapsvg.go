...
// SVGProlog is a announcement for the command line that the program is running
func SVGProlog() string {
	return "GoWrapSVG a tool to generate SVG 2-D Graphs, By David R. Larsen, 2020"
}
